...
const Timeline: React.FC<TimelineProps> = ({ conteudo }) => {
  ...
  const subtitulo = (conteudo?.subtitulo != null ? String(conteudo.subtitulo) : '') || 'Como construímos sites e landing pages que convertem. Uma metodologia em 5 fases para sua mensagem atingir o alvo e sua empresa decolar.';
