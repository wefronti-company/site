 ...
 <div className="max-w-7xl mx-auto">
	...
	>
		...
		{services.map((service, index) => (
			<div 
				key={index}
				className="group relative p-6 rounded-[10px] bg-gradient-to-br from-white/5 to-white/[0.02] transition-all duration-500 hover:-translate-y-1"
			...
			>
				...
				<div className="relative z-10">
					{/* Icon */}
					<div 
						className="w-12 h-12 rounded-[90px] flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300"
						style={{
					...
					>
						<div className="w-6 h-6 flex items-center justify-center" style={{ color: colors.blackColor }}>
							{service.icon}
						</div>
					</div>

					{/* Title */}
					<h3 className="font-semibold text-white mb-3" style={{ fontSize: '26px' }}>
						{service.name}
					</h3>

					{/* Description */}
					<p className="text-gray-400 leading-relaxed" style={{ fontSize: '18px' }}>
						{service.description}
					</p>
				</div>
			</div>
