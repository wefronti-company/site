...
const Hero: React.FC = () => {
 ...
 return (
 <section 
 className="w-full h-auto md:h-[90vh] bg-custom-white transition-colors duration-300 relative overflow-hidden border-b"
 style={{
 ...
 <h1 className="text-5xl md:text-6xl lg:text-6xl font-medium text-gray-900 leading-tight">
 {t.hero.title}
 </h1>
