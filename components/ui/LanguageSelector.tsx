...
const LanguageSelector: React.FC = () => {
 ...
 className="flex items-center gap-1.5 px-2 h-9 text-gray-600 hover:text-black transition-colors"
 >
 ...
 {isOpen && (
 <div className="absolute right-0 mt-2 w-48 bg-custom-white rounded-lg shadow-lg border border-gray-200 p-2 z-50">
 {languages.map((lang) => (
 <button
 key={lang.code}
