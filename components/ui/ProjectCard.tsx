...
const ProjectCard: React.FC<ProjectCardProps> = ({
 ...
 return (
 <div
 className="group flex flex-col bg-gray-100 transition-all duration-300 hover:scale-[1.02] overflow-hidden"
 style={{
 ...
 <div className="relative w-full h-[250px] md:h-[280px] overflow-hidden bg-gray-200">
 {customContent ? (
 ...
 <span
 key={index}
 className="px-3 py-1 text-xs text-gray-700 bg-gray-200"
 ...
 {/* Footer com Botão */}
 <div className="mt-auto pt-4 border-t" style={{ borderColor: '#D1D5DB' }}>
 <button
