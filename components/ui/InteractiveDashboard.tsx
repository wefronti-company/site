...
const InteractiveDashboard: React.FC = () => {
 ...
 <div>
 <h3 className="text-sm font-semibold text-gray-900">Painel de Vendas</h3>
 <p className="text-xs text-gray-500">Métricas em tempo real</p>
 </div>
 ...
 <div className="flex items-center justify-between mb-4">
 <div className="text-xs font-medium text-gray-600">Receita Mensal</div>
 ...
 <div>
 <div className="text-xs text-gray-900 font-medium">ROI: 94.2%</div>
