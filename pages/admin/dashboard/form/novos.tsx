...
const NovoOrcamentoModal: React.FC<{
  ...
  return (
    <div
      ...
      aria-modal
      aria-labelledby="modal-orcamento-title"
    >
      <div
        role="dialog"
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: spacing[6] }}>
          <h3 id="modal-orcamento-title" style={{ margin: 0, fontSize: fontSizes.lg, fontWeight: 500, color: colors.text.light }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[4], marginBottom: spacing[6] }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, minmax(0, 1fr))', gap: spacing[4] }}>
            ...
            <div style={fieldStyle}>
              <span style={labelStyle}>Tipo de projeto</span>
              <div style={valueStyle}>{request.tipo}</div>
            </div>
          </div>
          ...
          <div style={fieldStyle}>
            <span style={labelStyle}>Contexto / Mensagem</span>
...
const NovosOrcamentosPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Novos orçamentos | Wefronti</title>
        <meta name="robots" content="noindex, nofollow" />
      </Head>
      <AdminLayout>
        <h1 style={pageTitleStyle}>Novos orçamentos</h1>
        {loading ? (
          <div style={listStyle}>
          ...
          <p style={cardMetaStyle}>Nenhum orçamento novo.</p>
        ) : (
          <>
            <div style={listStyle}>
...
export default NovosOrcamentosPage;
