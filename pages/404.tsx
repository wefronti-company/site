  ...
  return (
    <>
      ...
      <main className="min-h-screen flex items-center justify-center px-8 md:px-16 lg:px-24 py-12 relative overflow-hidden" style={{ backgroundColor: colors.background.dark }}>
        <div className="w-full max-w-3xl md:max-w-6xl mx-auto flex items-center justify-center">
          <div className="flex flex-col items-center gap-6 text-center">
            {/* Badge igual ao FAQ */}
            <div className="flex items-center gap-2 px-3 py-1.5 rounded border border-white/10 w-fit">
              {/* Ícone Box igual FAQ */}
            ...
            <h1 className="text-4xl md:text-4xl lg:text-5xl font-light leading-[1.2] mb-2" style={{ color: colors.text.light }}>
