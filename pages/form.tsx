              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                        border: fieldErrors.name ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                      }}
                    />
                    {fieldErrors.name && (
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="relative flex-1">
                      <input
                        ...
                        style={{
                          backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                          border: fieldErrors.whatsapp ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                          height: '48px'
                        }}
                      />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{
                        backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                        border: fieldErrors.email ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                      }}
                    />
                    {fieldErrors.email && (
                      <div className="absolute right-3 top-1/2 -translate-y-1/2">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 rounded-lg text-gray-900 dark:text-white transition-all outline-none`}
                    style={{
                      backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                      border: fieldErrors.company ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                    }}
                  />
                  {fieldErrors.company && (
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{
                      backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                      border: fieldErrors.role ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                    }}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{
                      backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                      border: fieldErrors.revenue ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                    }}
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className={`w-full px-4 py-3 rounded-lg text-gray-900 dark:text-white transition-all resize-none outline-none`}
                    style={{
                      backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                      border: fieldErrors.challenge ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                    }}
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    style={{
                      backgroundColor: isDark ? colors.blackColor : colors.whiteColor,
                      border: fieldErrors.timeline ? '2px solid #EF4444' : `1px solid ${isDark ? colors.borderDark : colors.borderLight}`,
                    }}
                  >
                ...
                <div className="p-5 rounded-lg border-2" style={{
                  backgroundColor: isDark ? colors.blackColor : '#f8fafc',
